...
var ListItem = {
  render: function render(ref) {
    ...
    return this.isEditing 
      ? createNode( 'li', null, 
          createNode( 'form', { onsubmit: function (e) { if (!this$1.isCancel) { fruits[index] = this$1.value; } this$1.isEditing = false; e.preventDefault(); } }, 
            createNode( 'input', { value: this.value, oninput: function (e) { return this$1.value = e.target.value; }, autofocus: true }), 
            ' ', 
            createNode( 'button', null, "Save" ), 
            ' ', 
            createNode( 'button', { onclick: function () { this$1.isCancel = true; } }, "Cancel")
          )
        )
      : createNode( 'li', null, 
          createNode( 'p', null, fruit ), 
          createNode( 'p', null, 
            createNode( 'button', { onclick: function () { this$1.value = fruit; this$1.isEditing = true; } }, "Edit"), 
            ' ', 
            createNode( 'button', { onclick: function () { return fruits.splice(index, 1); } }, "Remove")
          )
        );
  }
};
...
var List = function () { return createNode( 'div', null, 
  createNode( 'form', { onsubmit: function (e) { fruits.push(name); e.preventDefault(); } }, 
    createNode( 'input', { oninput: function (e) { return name = e.target.value; }, autofocus: true })
  ), 
  createNode( 'ul', null, 
    fruits.map(function (fruit, index) { return createNode( ListItem, { fruit: fruit, index: index }); })
  )
); };

attachRoot(document.body, createNode( List, null ));
