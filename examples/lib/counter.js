...
var Counter = function () { return createNode( 'div', null, 
  createNode( 'p', null, "Counter: ", counter ), 
  createNode( 'p', null, 
    createNode( 'button', { onclick: function () { return counter++; } }, "+"), 
    ' ', 
    createNode( 'button', { onclick: function () { return counter--; } }, "-")
  )
); };

attachRoot(document.body, createNode( Counter, null ));
